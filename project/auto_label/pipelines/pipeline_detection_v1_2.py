...
from project.auto_label.datasets.kradar_detection_v2_2_demo import KRadarDetection_v2_2_demo

class PipelineDetection_v1_2():
    print('* PipelineDetection_v1_2')
    def __init__(self, path_cfg=None, ldr_dir=None, mode='train', path_log=None):
        '''
        ...
        *   'test'  denotes mode for inference
        ...
        self.cfg.DATASET.path_data.ldr_folder_header = ldr_dir
        print(self.cfg.DATASET.path_data.ldr_folder_header)
        ...
        self.dataset_test = KRadarDetection_v2_2_demo(self.cfg)
